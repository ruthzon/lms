...
const initialState = {
  school: {
    ...
    image: './img_from_xd/Image 117@2x.png',
    categories: [
...
const myschool = {
  ...
  setColorSchoolStudents(state, action) {
    state.school.colors.students = action.payload;
  },
  ...
  // Showwwwww
  showStudent(state) {
    state.school.show.students = !state.school.show.students;
  },
